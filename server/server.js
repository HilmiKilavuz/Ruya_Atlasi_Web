...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'ruyaatlasi23@gmail.com', // E-posta adresinizi buraya yazın
...
app.post('/api/send-verification-code', async (req, res) => {
  try {
    ...
    // E-posta içeriği
    const mailOptions = {
      from: 'ruyaatlasi23@gmail.com',
      to: email,
      subject: 'Rüya Atlası - E-posta Doğrulama Kodu',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          <div style="text-align: center; padding: 10px 0; background: linear-gradient(135deg, #1a237e, #4a148c); color: #ffffff; border-radius: 5px 5px 0 0;">
            ...
            <p style="margin: 5px 0 0;">E-posta Doğrulama Kodu</p>
          </div>
          <div style="padding: 20px;">
            <p>Merhaba ${username || 'Değerli Kullanıcı'},</p>
            <p>Rüya Atlası'na kaydolmak için e-posta adresinizi doğrulamanız gerekiyor. Aşağıdaki doğrulama kodunu kullanın:</p>
...
app.listen(PORT, () => {
  ...
  console.log(`  POST http://localhost:${PORT}/api/send-verification-code`);
  console.log(`  POST http://localhost:${PORT}/api/send-password-reset-code`);
